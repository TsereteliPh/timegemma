...
<?php if ( have_posts() ) : ?>
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<a href="<?php echo esc_url( get_permalink() ); ?>" class="modal__search-link" id="" aria-selected="false">
			<?php the_title(); ?>
		</a>
	<?php endwhile; ?>
<?php else : ?>
	<div class="searchwp-live-search-no-results" role="option">Keine ergebnisse gefunden</div>
<?php endif; ?>
